...
from datetime import datetime # we import 'datetime' to work with date and time in our API endpoints
...
def time():
    return {'current_time': datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
     # we specify that this endpoint only accepts POST requests
